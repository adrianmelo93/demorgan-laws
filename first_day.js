...
if ( (isMichaelPhelps || isMerman) && (isMichaelPhelps || hasGills) )
  ...
  if(isMichaelPehelps || (isMerman && hasGIlls))
  winGoldMedals();
...
function coinFlip(){
return Math.random() >= 0.5 ? "heads" : "butts"
}
...
function pickCard(){
    var suit = Math.random(Math.random()*3);
...
It will return true if one of the elements of the array is                         //falta
